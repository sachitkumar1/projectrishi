...
export const MEMBERS: Member[] = [
  ...
  { email: "narayannirali@berkeley.edu", firstName: "Nirali", lastName: "Narayan", group: "R", roles: roles({nmtLeader: true})},
  { email: "dilpreetvohra@berkeley.edu", firstName: "Jannat", lastName: "Vohra", group: "W", roles: roles({ lead: true})}
];
